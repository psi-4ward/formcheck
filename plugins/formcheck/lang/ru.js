formcheckLanguage = {
	...
	email: "Пожалуйста укажите правильный email: <br /><span>Например yourname@domain.kg</span>",
	phone: "Пожалуйста укажите правильный телефон.",
	url: "Пожалуйста укажите правильный адрес url: <br /><span>Например http://www.domain.kg</span>",
	
	confirm: "Это поле не должно отличаться от поля %0",
	differs: "Значение должно отличаться от значения в поле: %0",
	length_str: "Длина строки должна быть от %0 до %1 символов",
	length_fix: "Заполните поле строкой, состоящей ровно из %0 символов",
